...
[exile]
Type = MySQL
Name = {{getv "/exile/database/name"}}
Username = {{getv "/exile/database/user"}}
Password = {{getv "/exile/database/pass"}}
IP = {{getv "/exile/database/host"}}
Port = {{getv "/exile/database/port"}}
minSessions = 2
idleTime = 60
